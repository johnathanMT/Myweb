      ...
      <div className="mx-auto max-w-5xl">
        ...
        {!token ? (
          ...
          <form onSubmit={login} className="mx-auto mt-16 w-full max-w-sm rounded-2xl border border-fg/10 bg-fg/5 p-7">
            ...
            <a href="https://vedin.myothant.dev/vedin-admin" target="_blank" rel="noopener noreferrer" className="mt-4 block text-center font-mono text-[11px] text-violet-300 hover:text-violet-200">✦ Vedin Control Dashboard →</a>
          </form>
        ) : (
          /* ── DASHBOARD ── */
          <>
            <div className="mt-6 flex flex-wrap items-center gap-2">
              ...
              <a href="https://vedin.myothant.dev/vedin-admin" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 rounded-full border border-violet-400/40 bg-violet-500/10 px-4 py-2 font-mono text-xs text-violet-100 transition hover:bg-violet-500/20"><Sparkles size={13} /> Vedin Dashboard →</a>
            </div>
