            ...
            {LANGS.map(({ code, flag }) => (
              <button
                ...
                className={`w-8 h-7 rounded-lg text-sm flex items-center justify-center transition-all ${
                  lang === code ? 'bg-accent/70 shadow-sm' : 'hover:bg-white/10 opacity-60 hover:opacity-100'
                }`}
              >
                {flag}
              </button>
            ...
            <div className="flex items-center gap-1.5 flex-wrap">
              {LANGS.map(({ code, flag }) => (
                <button
                  ...
                  className={`w-9 h-8 rounded-lg text-sm transition-all ${
                    lang === code ? 'bg-accent/70' : 'bg-white/5 opacity-70 hover:opacity-100'
                  }`}
                >
                  {flag}
                </button>
