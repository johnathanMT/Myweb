...
export default function AmbientBackground() {
  return (
    <div aria-hidden className="pointer-events-none absolute inset-0 -z-10 overflow-hidden">
      ...
      <div className="absolute -top-40 left-1/4 h-[34rem] w-[34rem] -translate-x-1/2 rounded-full bg-lime-500/10 blur-[140px]" />
      {/* About region — deep purple */}
      <div className="absolute top-[24%] -right-40 h-[36rem] w-[36rem] rounded-full bg-purple-600/20 blur-[150px]" />
      {/* Articles region — sunset orange */}
      <div className="absolute top-[48%] -left-40 h-[32rem] w-[32rem] rounded-full bg-orange-500/12 blur-[140px]" />
      {/* Projects region — emerald */}
      <div className="absolute top-[70%] right-1/4 h-[32rem] w-[32rem] rounded-full bg-emerald-500/12 blur-[140px]" />
