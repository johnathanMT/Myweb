    ...
    <HelmetProvider>
      <BrowserRouter basename={BASENAME}>
        <Routes>
          ...
          <Route path="/jyotish" element={<><Seo title="Vedic Astrology — Rasi Chart Calculator" path="/jyotish" description="Free Vedic (sidereal, Lahiri) Rasi birth-chart calculator — planetary signs, houses, nakshatra & pada, powered by the Swiss Ephemeris." /><PageShell><Suspense fallback={<div className="py-24 text-center font-mono text-sm text-muted">Loading…</div>}><Jyotish /></Suspense></PageShell></>} />
